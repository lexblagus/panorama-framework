...
>
> **Framing lock:** avoid excess sky. The skyline and tower mass should occupy a large vertical share of the frame. If the solar disk must appear, it may be **partially cropped by the top edge**; do not lift framing to fit it.
>
> Lighting is **centered / frontal diffusion**, producing maximum atmospheric diffusion without harsh contrast. The solar disk may be **partially visible only here**, fully diffused through haze with no hard edge (it may read unnaturally large, as an atmospheric phenomenon). Shadows are minimal / symmetric and must not imply a strong left/right key.
>
...
>
> The image must read as the **equilibrium point of the entire panorama** — the peak of density, warmth, and atmospheric pressure — defining the visual and physical ceiling for all other tiles.
>
