...
>
> **Framing + scale continuity:** keep midground human traces visible (multiple settlement pockets + infrastructure cuts) so the tile maintains coherent scale continuity with Tile 3, while still remaining non-urban and non-grid.
>
