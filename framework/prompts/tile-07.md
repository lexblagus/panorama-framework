...
- Reference R1 (REQUIRED): Tile 7 composition map — `r1-composition-map.png`
- Reference A (REQUIRED): Tile 5 ruler image — `ruler.png`
- Reference B (OPTIONAL seam bridge composite): Tile 6 right crop + transparency + Tile 8 left crop — `bridge.png`
