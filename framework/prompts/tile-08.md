...
- Reference R1 (REQUIRED): Tile 8 composition map — `r1-composition-map.png`
- Reference A (REQUIRED): Tile 5 ruler image — `ruler.png`
- Reference B (REQUIRED seam bridge composite): Tile 7 right crop + transparency + Tile 9 left crop — `bridge.png`
