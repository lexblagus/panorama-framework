...
- Reference R1 (REQUIRED): Tile 6 composition map — `r1-composition-map.png`
- Reference A (REQUIRED): Tile 5 ruler image — `ruler.png`
- Reference B (REQUIRED seam bridge composite): Tile 5 right crop + transparency + Tile 7 left crop — `bridge.png`
...
- Tile 5–7 bridge composite (REQUIRED; edge continuity only).
