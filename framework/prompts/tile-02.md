...
- **Reference R1 (REQUIRED)**: Tile 2 composition map — `r1-composition-map.png`
- **Reference A (REQUIRED)**: Tile 5 ruler image — `ruler.png`
- **Reference B (REQUIRED seam bridge composite)**: Tile 1 right crop + transparency + Tile 3 left crop — `bridge.png`
