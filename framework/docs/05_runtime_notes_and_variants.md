...
The adapted prompt is **an execution artifact**, not the conceptual source of truth. This ordering applies only to **prompt adaptation/retention** for NanoBanana and does **not** replace the framework-wide **document authority ladder** defined in `docs/04_operational_pipeline.md`.
